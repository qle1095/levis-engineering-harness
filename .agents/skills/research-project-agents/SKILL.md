...
Not a README clone. Do not copy this harness’s pipeline from `orchestrator-e2e` or `orchestrator-learning` unless that directory actually uses this pipeline.
